...
check "AI Analysis Service" 3005 "http://127.0.0.1:3005/api/v1/health"
check "Workflow Service" 3007 "http://127.0.0.1:3007/api/v1/health"
check "Operations Service" 3008 "http://127.0.0.1:3008/api/v1/health"
